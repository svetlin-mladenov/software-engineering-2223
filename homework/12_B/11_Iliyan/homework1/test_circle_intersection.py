...
"""
#1 Fail case (radius <= 0)
circle_intersection(Circle((0, 0), 0), Circle((0, 0), -1))

#2 Same circle case
circle_intersection(Circle((-5, 6), 5), Circle((-5, 6), 5))

#3 Circle 1 inside Circle 2 (not same center) case
circle_intersection(Circle((29, 30), 5), Circle((0, 0), 50))

#4 Circle 1 inside Circle 2 (same center) case
circle_intersection(Circle((0, 0), 5), Circle((0, 0), 10))

#5 Circle 1 inside Circle 2 (touching) case
circle_intersection(Circle((-10, -12), 10), Circle((-10, 8), 30))

#6 Circle 2 inside Circle 1 (not same center) case
circle_intersection(Circle((10, 0), 50), Circle((-10, 0), 5))

#7 Circle 2 inside Circle 1 (same center) case
circle_intersection(Circle((10, 0), 10), Circle((10, 0), 5))

#8 Circle 2 inside Circle 1 (touching) case
circle_intersection(Circle((-10, 8), 30), Circle((-10, -12), 10))

#9 Circles touching from the outside case
circle_intersection(Circle((0, 0), 5), Circle((10, 0), 5))
circle_intersection(Circle((-10, 8), 30), Circle((14, -24), 10))

#10 Circles intersecting and their centers are not inside one another case
circle_intersection(Circle((-10, 8), 30), Circle((-10, -14), 10))

#11 Circles intersecting and one of them is lying on the other's circumference
circle_intersection(Circle((-10, 8), 30), Circle((20, 8), 10))

#12 Circles intersecting and their centers are inside one another case
circle_intersection(Circle((0, 0), 5), Circle((3, 0), 5))

#13 Circles not touching case
circle_intersection(Circle((0, 1), 2), Circle((10, 10), 5))
"""
